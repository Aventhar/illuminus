...
Object.assign(out, {
  ...
  "ILLUMINUS.Templates.Title": "Template Library",
  ...
  "ILLUMINUS.Templates.SidebarButton": "Templates",
...
const SECTION_TEXT = {
  ...
  background: ["Fill", "The color behind the contents"],
...
const FIELD_TEXT = {
  ...
  textColor: ["Text Color", "Lettering color in ordinary cells."],
  ...
  headerColor: ["Text Color", "Lettering color in the top row of a table."],
  ...
  captionColor: ["Text Color", "Lettering color of a picture's caption."],
  ...
  activeColor: ["Current Page Color", "Lettering color of the page you are reading."],
  ...
  buttonColor: ["Text Color", "Lettering and icon color on the panel's buttons."],
  ...
  buttonHoverColor: ["Text Color When Pointed At", "Lettering color while the mouse is over a button."],
