...
const SECTION_TEXT = {
  ...
  scrollbars: ["Scroll Bars", "The bars for scrolling, wherever one appears in this journal"],
...
const NOUN = {
  ...
  scrollbarHandleBorder: "handle edge", scrollbarHandleCorner: "handle",
...
const FIELD_TEXT = {
  ...
  scrollbarStyled: ["Draw Scroll Bars", "Whether Illuminus draws the scroll bars in this journal. Left off, Foundry draws its own thin bars and nothing below has any effect — a browser will do one or the other, never both."],
  scrollbarThickness: ["Thickness", "How wide a scroll bar is, and how tall a sideways one is."],
  scrollbarTrackBackground: ["Track Color", "The color of the groove the handle runs in."],
  scrollbarHandleBackground: ["Handle Color", "The color of the part you drag."],
  scrollbarHandleHoverBackground: ["Handle Color", "The color of the handle while the mouse is over it. Leave empty to keep the ordinary color."],
  pageButtonTop: ["Distance From Top", "How far below the top of the page the Edit button sits."],
  pageButtonFollows: ["Follows The Page", "The button travels down the page as it is scrolled, as Foundry's does. Turn this off to hold it at the top, where it cannot come to sit across a heading."],
