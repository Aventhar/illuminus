...
Object.assign(out, {
  ...
  "ILLUMINUS.Export.Title": "Export as Web Pages",
  "ILLUMINUS.Export.Button": "Export Journals\u2026",
  ...
  "ILLUMINUS.Export.Hint": "Saves the journals you pick as a folder of web pages, wearing the style you pick. They open in any browser, with no Foundry and no Illuminus needed \u2014 so you can hand a player a handout, or put an adventure on a website.",
  ...
  "ILLUMINUS.Export.FormatFolder": "A folder of web pages",
  "ILLUMINUS.Export.FormatFolderHint": "A zip holding one page per journal, its pictures, and its fonts. The fullest version, and the one to put on a website.",
  "ILLUMINUS.Export.FormatFile": "One web page",
  "ILLUMINUS.Export.FormatFileHint": "A single file with everything inside it, including the pictures. Larger, but you can email it to a player.",
  "ILLUMINUS.Export.FormatPrint": "Print, or save as PDF",
  "ILLUMINUS.Export.FormatPrintHint": "Opens the pages ready to print, where your browser can save them as a PDF. Each journal page starts a new sheet, and the contents panel is left out.",
  "ILLUMINUS.Export.ManyTitle": "{count} Journals",
  "ILLUMINUS.Export.PopupBlocked": "Your browser stopped the printable page from opening, so it has been saved instead. Open it and print from there.",
  "ILLUMINUS.Export.OptionsLegend": "What to Include",
  "ILLUMINUS.Export.Secrets": "Include hidden passages",
  "ILLUMINUS.Export.SecretsHint": "Off by default. A passage only the GM can see stays out of the export, so a handout cannot give the game away.",
